...
import io.github.runassudo.ptoffline.adapters.StationAdapter;
import io.github.runassudo.ptoffline.tasks.AsyncQueryNearbyStationsTask;
...
import static io.github.runassudo.ptoffline.data.RecentsDB.updateFavLocation;
import static io.github.runassudo.ptoffline.utils.TransportrUtils.getDragDistance;
import static io.github.runassudo.ptoffline.utils.TransportrUtils.getDrawableForLocation;
import static io.github.runassudo.ptoffline.utils.TransportrUtils.showLocationsOnMap;

public class NearbyStationsFragment extends TransportrFragment {

	public static final String TAG = "io.github.runassudo.ptoffline.nearby_locations";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		LocationGpsView.LocationGpsListener listener = new LocationGpsView.LocationGpsListener() {
			...
			@Override
			//public void deactivateGPS() { ui.stations_area.setVisibility(GONE); }
